...
controls = [
  {
    ...
    organizational_unit_ids = ["ou-uesj-67grwusj"], # Specify the OU or account ID
  },
  {
    control_names = [ 
      # Preventive control behavior: Prevents the creation of non-compliant resources.
      #"AWS-GR_CT_AUDIT_BUCKET_LOGGING_CONFIGURATION_CHANGES_PROHIBITED",          # Require encryption of attached Amazon EBS volumes for data at rest
...
policy_ids = [
  "p-g3k7rsaw"  # Deny of Region
  #"p-22230gpd",  # Deny IAM New Users
  #"p-3214k2y"  # Deny Terminate Ec2
]

target_id = "ou-uesj-67grwusj"  # Replace with your actual OU ID
